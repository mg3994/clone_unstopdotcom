...
const NavSidebar = ({ isExpanded }: NavSidebarProps) => {
  ...
  const mainNavItems = [
    ...
    { id: 'practice', label: 'Practice', path: '/practice', iconPos: '0 -170px', hasMenu: true },
    ...
    { id: 'events', label: 'Events', path: '/events', iconPos: '0 -102px' }, // fallback
                  ...
                  <li key={item.id} className="relative group">
                    <Link
                      ...
                      className={`
                        ...
                        ${isExpanded ? 'px-3 gap-2 w-full' : 'justify-center w-10 mx-auto'}
          ...
          <div className="nav-group border-t border-slate-100 pt-4 mt-2">
            ...
            <ul className="sidebar-menu m-0 p-0 list-none flex flex-col gap-0.5">
               <li className="relative group">
                  <div className={`menu-item h-10 rounded-xl flex items-center transition-all duration-200 group relative ${isExpanded ? 'px-3 gap-2 w-full' : 'justify-center w-10 mx-auto'} hover:bg-black/5 text-[#383838] cursor-pointer`}>
